...
def train_cnn(train_data, test_data, val_data, word_vectors, emb_len):
    ...
    for filter_size in filter_sizes:
        conv = Conv2D(num_filters, (filter_size, emb_len), activation='relu',
    ...
    print("Training...")
    hist_adam = model.fit(x_train, y_train, batch_size=32, epochs=25, verbose=0, validation_data=(x_val, y_val), shuffle=True)
